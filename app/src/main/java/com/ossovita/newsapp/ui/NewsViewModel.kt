...
import com.ossovita.newsapp.NewsApplication
...
class NewsViewModel(
    ...
    //create view model with generic resource
    ...
    //this function is alive as long as the viewmodel is alive
    //get news from api and post value to live data
    ...
    private suspend fun safeBreakingNewsCall(countryCode: String) {
        ...
        try {
            if (hasInternetConnection()) {
                ...
                //gelen response da oluşabilecek error'ları yönetebilmek için generic resource class'ı ile sarmala
